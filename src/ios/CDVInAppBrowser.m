...
- (BOOL)webView:(UIWebView*)theWebView shouldStartLoadWithRequest:(NSURLRequest*)request navigationType:(UIWebViewNavigationType)navigationType
{
    ...
    else if ([[ url scheme] isEqualToString:@"itms-appss"] || [[ url scheme] isEqualToString:@"itms-apps"]||[[ url scheme] isEqualToString:@"whatsapp"]|| [[ url absoluteString] hasPrefix:@"https://www.facebook.com"]) {
