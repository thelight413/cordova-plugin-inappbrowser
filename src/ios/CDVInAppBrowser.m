...
- (BOOL)webView:(UIWebView*)theWebView shouldStartLoadWithRequest:(NSURLRequest*)request navigationType:(UIWebViewNavigationType)navigationType
{
    ...
    else if ([[ url scheme] isEqualToString:@"itms-appss"] || [[ url scheme] isEqualToString:@"itms-apps"]||[[ url scheme] isEqualToString:@"whatsapp"]|| [[ url absoluteString] hasPrefix:@"https://www.facebook.com/sharer.php"]||[[ url absoluteString] hasPrefix:@"https://plus.google.com"]||[[ url absoluteString] hasPrefix:@"https://pinterest.com"]||[[ url absoluteString] hasPrefix:@"https://twitter.com"]) {
...
- (void)createViews
{
    ...
    UIImage *webimage = [UIImage imageNamed:@"icon.png"];
    self.imageButton = [[UIBarButtonItem alloc] initWithTitle:backArrowString style:UIBarButtonItemStylePlain target:self action:nil];
